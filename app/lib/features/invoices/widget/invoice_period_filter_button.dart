...
/// The "Filtrar por Período" button shown above the invoices table — opens a
/// month/year picker and reports the chosen period, or null for "todos os
/// períodos".
class InvoicePeriodFilterButton extends StatelessWidget {
  const InvoicePeriodFilterButton({super.key, required this.period, required this.onChanged});

  final InvoicePeriod? period;
  final ValueChanged<InvoicePeriod?> onChanged;

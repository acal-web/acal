  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        _buildSummaryRow('Valor Societario', invoice.membershipValue, currencyFormat),
        _buildSummaryRow('Valor Água', invoice.waterValue, currencyFormat),
        _buildSummaryRow('Água excedente', invoice.waterConsumedValue ?? 0.0, currencyFormat),
        const SizedBox(height: 12),

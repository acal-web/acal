...
/// (`Portal::InvoicesController`) scopes every query to the logged-in
/// customer, so there's no `customerId` param to pass here.
class CustomerInvoiceService {
  CustomerInvoiceService({HttpService? http}) : _http = http ?? HttpService();
